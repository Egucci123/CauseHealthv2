...
export const DoctorPrep = () => {
  ...
  return (
    <AppShell pageTitle="Clinical Prep" showDisclaimer>
      ...
      {/* Generic generation error — covers Anthropic timeouts, parse failures,
          network drops. Without this, generation that failed mid-flight just
          silently reverted to the empty state with no explanation. */}
      {genError && !isCapHit && (
