...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  past_due: { label: 'Past Due', color: '#C94F4F' }, canceled: { label: 'Canceled', color: '#131313' }, free: { label: 'Free Plan', color: '#131313' },
};
...
export const SubscriptionManagement = () => {
  const { status, isPro, isPastDue } = useSubscription();
