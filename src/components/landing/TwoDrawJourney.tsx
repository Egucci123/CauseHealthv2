...
const CASES: Case[] = [
  ...
  },
  {
    ...
    appAsksFor: ['Ferritin', 'Iron', 'TIBC', 'Transferrin Saturation', 'GGT', 'hs-CRP', 'Uric acid'],
    twelveWeekResult: 'Second draw: Ferritin 920, Iron sat 65%. CauseHealth flags hemochromatosis pattern → next step the doctor can order is HFE gene testing + liver imaging.',
