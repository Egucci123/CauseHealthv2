      ...
      <SectionCard>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input type="range" min={0} max={80} defaultValue={value.hoursWorkedPerWeek ?? 40} onChange={e => onChange({ hoursWorkedPerWeek: parseInt(e.target.value) })} className="w-full accent-primary-container" />
          </div>
        </div>
      </SectionCard>
      ...
      <SectionCard>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input type="range" min={0} max={10} defaultValue={value.cookHomeFrequency ?? 5} onChange={e => onChange({ cookHomeFrequency: parseInt(e.target.value) })} className="w-full accent-primary-container" />
          </div>
        </div>
      </SectionCard>
