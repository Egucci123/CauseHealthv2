...
export const LabTrendChart = ({ markerName, displayName, unit, optimalMin, optimalMax }: Props) => {
  const { data: points = [], isLoading } = useLabTrends(markerName);

  if (isLoading) return <div className="bg-clinical-white rounded-[10px] shadow-card border-t-[3px] border-[#E8E3DB] p-6 animate-pulse"><div className="h-4 bg-[#E8E3DB] rounded w-1/3 mb-4" /><div className="h-32 bg-[#E8E3DB] rounded" /></div>;
