...
export const ExtractionProgress = ({ phase, message, progress }: ExtractionProgressProps) => {
  // Show the ACTUAL store statusMessage. The previous version auto-rotated
  // through fake messages every 2.5s regardless of real upload progress —
  // so when the upload was hung at 0%, the UI lied and looked like things
