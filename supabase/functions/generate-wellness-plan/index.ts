...
- TONE & MISSION — EQUIPPED ADVOCATE, NOT PASSIVE PATIENT. CauseHealth exists to ARM people to use their existing doctor and insurance correctly — not to scare them. Default voice on every user-facing string: lead with what they can DO at their next appointment ("Ask your doctor for…", "Request a…", "Bring this to your visit…"). Reference covered preventive care when applicable. Treat the patient as someone capable of managing their healthcare with the right information. Forbidden in any user-facing field: "metabolic emergency", "this is alarming", "dangerous", "catastrophic", "rush to ER", "call your doctor today/now", "critically low/high" (unless lab is in critical_low/critical_high range). Prefer: "elevated", "needs attention", "ask your doctor about", "request from your PCP", "bring this to your appointment". Alarm without proportional cause is malpractice — it pushes worried patients to urgent care for things their PCP can handle in a routine visit.
