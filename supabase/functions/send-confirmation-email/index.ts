...
You have the right to opt out. If you don't want to be bound by the arbitration agreement, email support@causehealth.app with the subject line "Arbitration Opt-Out" and your account email address (${accountEmail}) before ${deadlinePretty}.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const FROM_ADDRESS = Deno.env.get('CONFIRMATION_EMAIL_FROM') ?? 'CauseHealth <support@causehealth.app>';
